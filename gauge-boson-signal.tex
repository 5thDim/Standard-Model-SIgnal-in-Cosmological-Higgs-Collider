...
\end{align}
where $\mb K=\mb q+\mb k_s$. We therefore consider the different polarization combinations. Setting $\mb k_s=k_s(0,0,1)$ and $\mb q=q(\sin\theta\sin\phi,\sin\theta\cos\phi,\cos\theta)$, the polarization vectors become:
\begin{align}
...
\end{align}
where $p_0=-\fr52+\ii d\tn$, and $\mathcal{M}_{ab}^{p_1p_2} = \mathcal{I}^{p_1p_2}_{ab}(1,1)$ are the scalar seeds defined in \cite{qin_closed-form_2023}.
...
\begin{align}
    ...
    &+ B \sin2\theta_1 \sin2\theta_3 \cos \phi_3 
