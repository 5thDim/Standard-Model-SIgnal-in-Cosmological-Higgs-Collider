...
\begin{align}
    \la \delta h^4 \ra^{\text{Bubble}} &= \left( ig^2 \right)^2 \sum_{a,b=\pm} (ab) \int \frac{\di \tau_1}{|H \tau_1|^2} \frac{\di \tau_2}{|H \tau_2|^2} G_a(k_1;\tau_1) G_a(k_2;\tau_1) G_b(k_3;\tau_2) G_b(k_4;\tau_2) \nonumber \\
...
\begin{align}
    \mathcal{T}^{(L)}_c &= (ig^2) \sum_a a \int \frac{\di \tau_1}{|H \tau_1|^2} G_a(k_1;\tau_1) G_a(k_2;\tau_1) (-\tau_1)^{1+2ic\tn} \nonumber \\
    &= (ig^2) \frac{H^2}{4k_1^3 k_2^3} \sum_{a=\pm} a \int_{-\infty}^{0} \di \tau_1 (-\tau_1)^{-1+2\ii c\tn} (1 -iak_{12}\tau_1-k_1k_2\tau_1^2) e^{iak_{12}\tau_1} \nonumber \\
    &= (ig^2) \frac{H^2}{4k_1^3 k_2^3} \times k_{12}^{-2ic\tn} \cdot \mathcal{P}^{(1)}_c(\tn)
\end{align}
where the coefficient is:
\begin{align}
    \mathcal{P}^{(1)}_c(\tn) = \frac{2+ic\tn}{2ic\tn} \sinh(\pi c \tn) \Gamma(2+2\ii c\tn)
\end{align}

Also for the right subgraph:
\begin{align}
    \mathcal{T}^{(R)}_c = (ig^2) \frac{H^2}{4k_3^3 k_4^3} \times k_{34}^{-2ic\tn} \cdot \mathcal{P}^{(1)}_c(\tn)
\end{align}

So the total bubble graph contribution:
\begin{align}
    \la \delta h^4 \ra^{\text{Bubble}} &= \sum_{c=\pm} \mathcal{T}^{(L)}_c \mathcal{T}^{(R)}_c \mathcal{B}_c \\
    &= (ig^2)^2 \frac{H^4 k_s^3}{16 k_1^3 k_2^3 k_3^3 k_4^3} \left( \frac{k_s^2}{4k_{12}k_{34}}\right)^{2\ii\tn} \times C^{\text{Bub}}(\tn) + \text{c.c.}
\end{align}
...
\begin{align}
    \la \delta h^4 \ra^{\text{Tri1}} &= \left( ig^2 \right) (ig^2h_0)^2 \sum_{a,b,c=\pm} (abc) \int \frac{\di \tau_1}{|H \tau_1|^2} \frac{\di \tau_2}{|H \tau_2|^2} \frac{\di \tau_3}{|H \tau_3|^2} G_a(k_1;\tau_1) G_a(k_2;\tau_2) G_c(k_3;\tau_3) G_c(k_4;\tau_3) \nonumber \\
...
\begin{align}
    \mathcal{T}^{(L),\lambda}_d &= (ig^2h_0)^2 \sum_{a,b=\pm} (ab) \int \frac{\di \tau_1}{|H \tau_1|^2} \frac{\di \tau_2}{|H \tau_2|^2} G_a(k_1;\tau_1) G_b(k_2;\tau_2) \nonumber \\
...
\begin{align}
    ...
    &\left[ +\tilde{\mathcal{K}}_{ab}^{-\fr32+id\tn,-\fr32+id\tn} (1,1) 
    - ia \tilde{\mathcal{K}}_{ab}^{-\fr12+id\tn,-\fr32+id\tn} (1,1) \right. \nonumber \\
    &\left. -ib \tilde{\mathcal{K}}_{ab}^{-\fr32+id\tn,-\fr12+id\tn} (1,1) 
    - ab \tilde{\mathcal{K}}_{ab}^{-\fr12+id\tn,-\fr12+id\tn} (1,1) \right]
\end{align}
and here the $\mathcal{K}_{ab}^{p_1p_2} = \mathcal{I}^{(L)p_1p_2}_{ab}$ in \cite{qin_helical_2023}. The opposite-sign seeds:
\begin{align}
    \mathcal{K}_{\pm\mp}^{p_1p_2}(1,1) = \frac{e^{\mp i\pi(p_1-p_2)/2}}{4\pi(\tilde{\nu}^2 + \frac{1}{4})} \left[ \mathbf{H}_{\tilde{\nu}}^{p_1}(1) \left(\frac{1}{2}\right)^{i\tilde{\nu}} + \mathbf{H}_{-\tilde{\nu}}^{p_1}(1) \left(\frac{1}{2}\right)^{-i\tilde{\nu}} \right] \nonumber \\
...
\begin{align}
    \mathcal{K}_{\pm\pm}^{p_1p_2}(1,1) &= \frac{-i e^{\mp i\pi(p_1+p_2)/2}}{4\pi(\tilde{\nu}^2 + \frac{1}{4})} \left[ e^{\pi\tilde{\nu}} \mathbf{H}_{\tilde{\nu}}^{p_1}(1) \left(\frac{1}{2}\right)^{i\tilde{\nu}} + e^{-\pi\tilde{\nu}} \mathbf{H}_{-\tilde{\nu}}^{p_1}(1) \left(\frac{1}{2}\right)^{-i\tilde{\nu}} \right] \\
    &\quad \times \left[ \mathbf{H}_{\tilde{\nu}}^{p_2}(1) \left(\frac{1}{2}\right)^{i\tilde{\nu}} + \mathbf{H}_{-\tilde{\nu}}^{p_2}(1) \left(\frac{1}{2}\right)^{-i\tilde{\nu}} \right] \nonumber \\
    &+ \frac{e^{\mp i\pi(p_1+p_2)/2}}{2(\tilde{\nu}^2 + \frac{1}{4})}  \sum_{n_1,n_2=0}^{\infty} \frac{(-1)^{n_{12}}}{n_1! n_2!} \left( \frac{1}{2} \right)^{2n_{12}} \\
    &\quad \times \frac{i}{\tilde{\nu}} \left( 2n_1 - \frac{1}{2} + i\tilde{\nu} \right) \left( 2n_2 - \frac{1}{2} - i\tilde{\nu} \right) (-i\tilde{\nu})_{-n_1} (i\tilde{\nu})_{-n_2} \\
...
\begin{align}
    \mathcal{P}_d^{(2),\pm}(\tn) 
    = -2^{2id\tn} \cdot \sum_{a,b=\pm} 
    &\left[ +\tilde{\mathcal{M}}_{ab}^{-\fr52+id\tn,-\fr52+id\tn} (1,1) 
    - ia \tilde{\mathcal{M}}_{ab}^{-\fr32+id\tn,-\fr52+id\tn} (1,1) \right. \nonumber \\
    &\left. -ib \tilde{\mathcal{M}}_{ab}^{-\fr52+id\tn,-\fr32+id\tn} (1,1) 
    - ab \tilde{\mathcal{M}}_{ab}^{-\fr32+id\tn,-\fr32+id\tn} (1,1) \right]
\end{align}
and here $\mathcal{M}_{ab}^{p_1p_2} = \mathcal{I}^{p_1p_2}_{ab}$ in \cite{qin_closed-form_2023}.
The opposite-sign seeds:
\begin{align}
    \mc M^{p_1 p_2}_{\pm\mp}(1,1) = 
...
\begin{align}
    \mathcal{T}^{(R)}_d &= (ig^2) \sum_c c \int \frac{\di \tau_3}{|H \tau_3|^2} G_c(k_3;\tau_1) G_c(k_4;\tau_3) (-\tau_3)^{1+2\ii d\tn} \nonumber \\
    &= (ig^2) \frac{H^2}{4k_3^3 k_4^3} \sum_{c=\pm} c \int_{-\infty}^{0} \di \tau_3 (-\tau_3)^{-1+2\ii c\tn} (1 -ick_{34}\tau_3-k_3k_4\tau_3^2) e^{ick_{34}\tau_3} \nonumber \\
    &= (ig^2) \frac{H^2}{4k_3^3 k_4^3} \times k_{34}^{-2\ii d\tn} \cdot \mathcal{P}^{(1)}_d(\tn)
\end{align}
where the coefficient is:
\begin{align}
    \mathcal{P}^{(1)}_d(\tn) = \frac{2+\ii d\tn}{2\ii d\tn} \sinh(\pi d \tn) \Gamma(2+2\ii d\tn)
\end{align}
